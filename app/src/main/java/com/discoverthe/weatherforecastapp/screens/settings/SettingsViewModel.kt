...
class SettingsViewModel(private val repository: WeatherDbRepository) : ViewModel() {
    private val _unitList = MutableStateFlow<List<com.discoverthe.weatherforecastapp.model.Unit>>(emptyList())
    ...
    fun insertUnit(unit: com.discoverthe.weatherforecastapp.model.Unit) =
        viewModelScope.launch { repository.insertUnit(unit) }

    fun updateUnit(unit: com.discoverthe.weatherforecastapp.model.Unit) = viewModelScope.launch {
        repository.updateUnit(unit)
    }

    fun deleteUnit(unit: com.discoverthe.weatherforecastapp.model.Unit) = viewModelScope.launch {
